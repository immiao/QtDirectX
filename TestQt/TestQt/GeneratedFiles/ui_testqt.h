...
public:
    ...
    void setupUi(QMainWindow *TestQtClass)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/TestQt/DrawLine.png"), QSize(), QIcon::Normal, QIcon::Off);
        drawLine->setIcon(icon);
        choose = new QAction(TestQtClass);
        choose->setObjectName(QStringLiteral("choose"));
        choose->setCheckable(true);
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/TestQt/Choose.png"), QSize(), QIcon::Normal, QIcon::Off);
